#==================================================
# Breast Cancer Survival Analysis: CG  by Tau
#==================================================
...
setwd("C:/Users/a0025724/OneDrive - University of Witwatersrand/RESEARCH/Copula/Code/Copua dependence/")
#-------------------------
...
ggsurvplot(fit_overall, data = my_data, risk.table = TRUE, title = "Kaplan-Meier: Overall Survival")

#-------------------------
# Median-based High/Low grouping
#-------------------------
genes <- c("ARID3A","CCNA2")
...
#==================================================
# Copula-Graphic (CG) curves per copula  gene 
#==================================================
...
attach(my_data)
CG.test(t.vec=follow_up_duration, d.vec=event_death, PI = ARID3A, alpha=2, N=1000, copula=CG.Clayton, S.plot=TRUE)
...
#==================================================
# Copula-Cox regression (per-gene HR + joint p-value)
#==================================================
...
#==================================================
# Prognostic Index 1 (PI_genes_all) via all genes
#==================================================
...
#==================================================
# Prognostic Index 2 (PI_select) via selected 3 genes (ARID3A, CCNA2, G6PD)
#==================================================
...
#==================================================
# Copula-Graphic (CG) Curves for PI_genes_all and PI_select
#==================================================
...
#==================================================
# Combine PI_genes_all and PI_select Summary Table
#==================================================
...
#==================================================
# Copula-Graphic Test and HR Summary Tables
#==================================================
